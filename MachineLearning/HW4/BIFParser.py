...
def parseBIF(BIF):
    ...
    while i<len(BIF):
        ...
        if lineList[0] == 'variable':
            ...
            nodes.append(Node(name,theType,numStates,theStates, theProperty))
            ...
            while BIF[i]!='}':   
                ...
                if lineList[0] == 'table':
                    ...
                    prob = [x.translate(table) for x in lineList]
                    ...
                    table = str.maketrans(dict.fromkeys('(,;)'))
                    line_lst = [states.translate(table) for states in lineList]
